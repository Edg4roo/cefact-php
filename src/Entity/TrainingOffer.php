...
class TrainingOffer
{
    ...
    #[ORM\ManyToOne(inversedBy: 'training_offers')]
    ...
    #[ORM\OneToMany(mappedBy: 'training_offer', targetEntity: Request::class)]
    ...
    public function removeRequest(Request $request): self
    {
        if ($this->request->removeElement($request)) {
            ...
            if ($request->getTrainingOffer() === $this) {
                $request->setTrainingOffer(null);
            }
        }
